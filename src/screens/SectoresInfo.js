...
export function SectoresInfo() {
	...
	return (
		<View style={styles.container}>
			<Image source={require('../utils/sedro.jpeg')} style={styles.backgroundImage} />
			...
			<View style={styles.descriptionContainer}>
				...
				<Text style={styles.descriptionText}>
					El cedro amargo nombre científico cedrela odorata, familia botánica meliaceae, es un árbol nativo de
					Costa Rica conocido por su madera y conocidas flores. Se puede encontrar desde México hasta
					Suramérica y el Caribe, desde el nivel del mar hasta aproximadamente 1400 metros de elevación.
				</Text>
			</View>
			<View style={styles.buttonContainer}>
				...
				<TouchableOpacity style={[styles.button, styles.listenButton]} onPress={playAudio}>
					<Icon name={isPlaying ? 'pause' : 'play'} type="font-awesome" color="white" size={20} />
